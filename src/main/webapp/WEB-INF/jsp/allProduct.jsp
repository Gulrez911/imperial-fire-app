								...
								<div class="prod">
									...
									<div class="top-section">
										<div class="img-section">
											<a href="#"> <img src="${'/image?img='}${list.imageName}" alt="Product Image">
											</a>
										</div>
										<div class="prod-details-section-main">
											<div class="custom-field-section">
												<ul>
													...
													<li title="Supply Ability: 100 Per Month"><strong>Supply Ability:</strong><i>
															${list.supplyAbility}</i></li>

													<li title="Warranty: Yes"><strong>Warranty:</strong><i> ${list.warranty}</i></li>

													<li title="Usage: Industrial"><strong>Usage:</strong><i> ${list.productUsage}</i></li>

													<li title="Color: Grey"><strong>Color:</strong><i> ${list.color}</i></li>

													<li title="Material: Metal"><strong>Material:</strong><i> ${list.material}</i></li>

													<li title="Application: Fire"><strong>Application:</strong><i> ${list.application}</i></li>

													<li title="Product Type: Fire Suppression System"><strong>Product Type:</strong><i>
															${list.productType}</i></li>
									...
									<div class="btn-section">
										...
										<a id="send_a_inq_10134762" class="btn btn-primary inq_button"
											onclick="callRequest('${list.name}','${'/image?img='}${list.imageName}', '${list.id}');"
										>Send Inquiry</a>
